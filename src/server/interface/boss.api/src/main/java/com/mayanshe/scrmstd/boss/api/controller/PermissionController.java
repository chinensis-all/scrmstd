...
public class PermissionController {
     ...
     */
    @PostMapping("/{id}/lock")
    public void destroyPermission(@PathVariable("id") String id) {
    ...
    public void activatePermission(@PathVariable("id") String id) {
    ...
    public Object getPermissionOptions(
        ...
        if (groupId != null && !groupId.isBlank()) {
            groupIdLong = IdGenerator.fromBase62(groupId);
        }
        return queryBus.execute(new PermissionOptionQuery(groupIdLong, keywords));
    }
    ...
    public Object getPermissionPagination(
        ...
        return queryBus.execute(new PermissionPaginationQuery(groupIdLong, keywords, deleted, page, pageSize));
    }
}
