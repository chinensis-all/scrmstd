 ...
 */
@Service
public class ModifyEmailTemplateHandler implements CommandHandler<ModifyEmailTemplateCommand, Void> {
    private final EmailTemplateRepository repository;
    private final DomainEventPublisher publisher;

    public ModifyEmailTemplateHandler(EmailTemplateRepository repository, DomainEventPublisher publisher) {
