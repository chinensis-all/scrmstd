 ...
 */
package com.mayanshe.scrmstd.application.message.query.repo;
...
/**
 * EmailTemplateQueryRepository: 邮件模板查询仓储接口
 */
public interface EmailTemplateQueryRepository extends QueryRepository<EmailTemplateDto, OptionDto, Long> {
}
