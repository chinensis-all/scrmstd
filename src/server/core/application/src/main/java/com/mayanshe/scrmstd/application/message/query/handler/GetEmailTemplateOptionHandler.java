 ...
 */
@Service
public class GetEmailTemplateOptionHandler implements QueryHandler<EmailTemplateOptionQuery, List<OptionDto>> {
    private final EmailTemplateQueryRepository repository;

    public GetEmailTemplateOptionHandler(EmailTemplateQueryRepository repository) {
        this.repository = repository;
    }

    @Override
    public List<OptionDto> handle(EmailTemplateOptionQuery query) {
