...
import com.mayanshe.scrmstd.application.tenant.query.repo.PermissionQueryRepository;
...
/**
 * PermissionOptionQueryHandler: 获取权限选项查询处理器
 */
@Service
public class PermissionOptionQueryHandler implements QueryHandler<PermissionOptionQuery, List<OptionDto>> {
    private final PermissionQueryRepository repository;

    public PermissionOptionQueryHandler(PermissionQueryRepository repository) {
