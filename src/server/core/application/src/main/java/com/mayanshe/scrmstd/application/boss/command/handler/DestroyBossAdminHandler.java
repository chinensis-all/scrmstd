...
import com.mayanshe.scrmstd.application.boss.command.DestroyedBossAdminCommand;
import com.mayanshe.scrmstd.domain.boss.admin.repo.BossAdminRepository;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

@Service
public class DestroyBossAdminHandler implements CommandHandler<DestroyedBossAdminCommand, Boolean> {
    private final BossAdminRepository repository;

    private final DomainEventPublisher publisher;

    public DestroyBossAdminHandler(BossAdminRepository repository, DomainEventPublisher publisher) {
    ...
    @Override
    @Transactional
    public Boolean handle(DestroyedBossAdminCommand command) {
