...
public class FileStoredEvent {
    ...
    public String fileUrl;         // 全路径(如果有CDN，则是CDN路径)

    public String mimeType;        // MIME类型

    public String mediaType;       // 媒体类型(image、video、audio、document等)

    public Long size;              // 大小(kb)

    public boolean isPublicRead;   // 是否是共有读
